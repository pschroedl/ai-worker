...
required_files=(
    ...
    "checkpoints/240126_real3dportrait_orig/audio2secc_vae/config.yaml"
    "checkpoints/240126_real3dportrait_orig/audio2secc_vae/model_ckpt_steps_400000.ckpt"
    "checkpoints/240126_real3dportrait_orig/secc2plane_torso_orig/config.yaml"
    "checkpoints/240126_real3dportrait_orig/secc2plane_torso_orig/model_ckpt_steps_100000.ckpt"
